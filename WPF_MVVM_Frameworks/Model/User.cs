...
namespace WPF_MVVM_Frameworks.Model
{
    class User : INotifyPropertyChanged
    {
        ...
        public string ID { get { return _id; } set { _id = value; NotifyOfPropertyChange("ID"); } }

        public string FirstName { get { return _firstName; } set { _firstName = value; NotifyOfPropertyChange("FirstName"); } }

        public string LastName { get { return _lastName; } set { _lastName = value; NotifyOfPropertyChange("LastName"); } }

        public string Address { get { return _address; } set { _address = value; NotifyOfPropertyChange("Address"); } }
